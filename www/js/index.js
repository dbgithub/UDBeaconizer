...
var _tooltipTimer; // Timer for a tooltip message on the screen.
    ...
    var frequencyHistogram = []; // An array holding the number of times that a certain beacon has been scanned for each and every beacon. The index is the instance numbers of the beacon and the value is the appearance frequency.
